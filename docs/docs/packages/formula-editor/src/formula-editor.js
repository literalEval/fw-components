...
let FormulaEditor = class FormulaEditor extends LitElement {
  constructor() {
    ...
    this.errorStr = null;
    this.calculatedResult = null; // If this parseInput is called to add a recommendation, say by clicking,
  ...
  parseInput(addRecommendation = null) {
    ...
    editor === null || editor === void 0 ? void 0 : editor.focus(); // this.calculatedResult = this._parser.calculate(this.content)!;
...
__decorate([state()], FormulaEditor.prototype, "formattedContent", void 0);

__decorate([state()], FormulaEditor.prototype, "recommendations", void 0);

__decorate([state()], FormulaEditor.prototype, "errorStr", void 0);

__decorate([state()], FormulaEditor.prototype, "calculatedResult", void 0);

FormulaEditor = __decorate([customElement("formula-editor")], FormulaEditor);
export { FormulaEditor }; //# sourceMappingURL=formula-editor.js.map
